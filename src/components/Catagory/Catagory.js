...
const Catagory = () => {
      ...
      return (
            <div className="Catagory p-5 container">
                  <div className="shop-category">
                        <div className="top-part">
                              ...
                              <div className="button-container">
                                    <button className="btn__0">New Arrivals</button>
                                    <button className="btn__1">Featured</button>
                                    <button className="btn__1">Best Sellers</button>
                              </div>
                        </div>
                  </div>
                  <div className="row">
